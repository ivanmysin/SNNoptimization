...
solution, loss = net.fit(t, Targets_spikes_rates, n_inter=5, win4_start = 2000, win4grad = 500)
path = path4savingresults_template.format(number_of_simulation + 1)
net.save_simulation_data(path, solution, Targets_spikes_rates)
print("Прогон № ", (number_of_simulation + 1), ", Loss = ", float(loss))
